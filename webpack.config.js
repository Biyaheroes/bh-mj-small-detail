...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./small-detail.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "small-detail",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "small-detail.deploy.js"
		},
